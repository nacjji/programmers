...
let ans = ''
const solution = (food) => {
    // 첫 번째 인덱스는 물이기 때문에 1부터 시작
    for (let i = 1; i < food.length; i++) {
        // 문자열 메소드인 repeat을 사용하기 위해 문자열 형변환
        ans += String(i).repeat(food[i] / 2)
    }
    // 깊은 복사, 뒤집기, 합치기
    return ans + '0' + [...ans].reverse().join('')
}

console.log(solution([1, 3, 4, 6])) // 물 1, 1번음식 3개, 2번음식 0개, 3번음식 6개 -> "111303111"
