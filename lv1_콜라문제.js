...
const solution = (a, b, n) => {
    ...
    while (n >= a) {
        // 콜라를 받을 수 없을 때까지 반복
        cola += Math.floor(n / a) * b // 현재 가지고 있는 빈병 개수에 빈병을 줬을 때 받는 콜라 수를 곱해주고
        n = Math.floor(n / a) * b + (n % a) // 빈병 내고 받은 콜라에 나머지 빈병을 더해줘서 다음 반복 때 쓸 수 있게 함
    }
    return cola
}

console.log(solution(5, 3, 21)) //19
